...
namespace ArkaPRP83.Core.Helper
{
    public sealed class SqlHelper
    {
        ...
        private SqlHelper() { }
        public static DataTable ExecuteDataTable(string connectionString, CommandType commandType, string commandText, NpgsqlParameter[] parameters = null)
        {
        ...
        public static int ExecuteNonQuery(string conectionString, CommandType commandType, string commandText, NpgsqlParameter[] parameters = null)
        {
            using (var conn = new NpgsqlConnection(conectionString))
            {
                conn.Open();
                using (var cmd = new NpgsqlCommand(commandText, conn))
                {
